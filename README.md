...
**DeadlySIn777 Studio fork — 0.18.12 development build.** This fork adds the
...
| Ask refill | On = every print starts with a "VAT filled full?" question (Yes resets the estimate to a full VAT, so answer yes only after a full refill) |
